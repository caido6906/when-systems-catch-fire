...
- [ANS-0004｜秦统一失败不是因为硬件不够，而是退出权被压成了符号 / Qin failed because exit rights were compressed into symbols, not because the hardware was insufficient](../items/ANS-0004.md)
