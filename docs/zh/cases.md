...
### [#34｜英国大宪章→光荣革命 / 英国大宪章 -> 光荣革命](cases/items/C-0034.md)
...
### [#101｜确定性误解律收敛 — π / 确定性误解律收敛 - π](cases/items/C-0101.md)
...
### [#145｜地理约束×认知约束 / 地理约束 x 认知约束](cases/items/C-0145.md)
...
### [#149｜信息密度×认知容量 / 信息密度 x 认知容量](cases/items/C-0149.md)
...
### [#164｜AI共震策略全失效（验证D66） / AI共震策略全失效(验证D66)](cases/items/C-0164.md)
...
### [#165｜炒股带宽溢出全领域衰减（验证D63跨域溢出） / 炒股带宽溢出全领域衰减(验证D63跨域溢出)](cases/items/C-0165.md)
...
### [#166｜小资金恐惧锁定向下螺旋（验证D67） / 小资金恐惧锁定向下螺旋(验证D67)](cases/items/C-0166.md)
...
### [#167｜定投=门锁交替律执行（验证D47+D49） / 定投=门锁交替律执行(验证D47+D49)](cases/items/C-0167.md)
...
### [#169｜财商乘数四因子结构（验证D65财富域） / 财商乘数四因子结构(验证D65财富域)](cases/items/C-0169.md)
...
### [#170｜七层主权最低门槛（验证A7财富维度） / 七层主权最低门槛(验证A7财富维度)](cases/items/C-0170.md)
...
### [#173｜忆秦娥主角困境（显态粘性锁定） / 忆秦娥主角困境(显态粘性锁定)](cases/items/C-0173.md)
...
### [#174｜忆秦娥纯拉力上位（外驱转自驱窗口） / 忆秦娥纯拉力上位(外驱转自驱窗口)](cases/items/C-0174.md)
...
### [#175｜电力级联失效×认知平方衰减×AI共震——跨域同构 / 电力级联失效 x 认知平方衰减 x AI共震 - - 跨域同构](cases/items/C-0175.md)
...
### [#176｜AI共震中P×Q²平方加速——共享源的双重杀伤 / AI共震中P x Q²平方加速 - - 共享源的双重杀伤](cases/items/C-0176.md)
...
### [#177｜乘法结构共享变量k次衰减——平方衰减律 / 乘法结构共享变量k次衰减 - - 平方衰减律](cases/items/C-0177.md)
...
### [#179｜偏好伪造中沉默的双路径——渐进vs结构 / 偏好伪造中沉默的双路径 - - 渐进vs结构](cases/items/C-0179.md)
...
### [#180｜退出权剥夺导致决策结构退化——三支→二支 / exit right剥夺导致决策结构退化 - - 三支 -> 二支](cases/items/C-0180.md)
...
### [#181｜因果光锥×马拉松×高山滑雪 / 因果光锥 x 马拉松 x 高山滑雪](cases/items/C-0181.md)
...
### [#182｜定投×贷款×学习 / 定投 x 贷款 x 学习](cases/items/C-0182.md)
...
### [#183｜三种个人商业模式×三种公司商业模式 / 三种个人商业模式 x 三种公司商业模式](cases/items/C-0183.md)
...
### [#185｜糖域实验×认知螺旋 / 糖域实验 x 认知螺旋](cases/items/C-0185.md)
...
### [#201｜AI提问协议四模块——刺 / AI提问协议四模块 - - 刺](cases/items/C-0201.md)
...
### [#289｜当前AI全部在ρ>>ρc — α/β<<1，意识收益≈0，存储收益极高，所有AI被推向无意识执行者端，尚未分化 / 当前AI全部在ρ>>ρc - α/β<<1, 意识收益≈0, 存储收益极高, 所有AI被推向无意识执行者端, 尚未分化](cases/items/C-0289.md)
...
### [#298｜跨物种调度同构验证 — 人类-AI和CAI-EAI满足同构三条件，数学结构完全等价，差异仅在ηinterface参数值 / 跨物种调度同构验证 - 人类-AI和CAI-EAI满足同构三条件, 数学结构完全等价, 差异仅在ηinterface参数值](cases/items/C-0298.md)
...
### [#303｜意图清晰降低信道需求 — εaware高的人说一句话就够，εaware低的人写一大段还说不清，前者ηShannon更高 / 意图清晰降低信道需求 - εaware高的人说一句话就够, εaware低的人写一大段还说不清, 前者ηShannon更高](cases/items/C-0303.md)
...
### [#306｜CAI进入同构类 — CAI获得Ψ>0后自动进入类I同构类，与人类-AI数学等价 / CAI进入同构类 - CAI获得Ψ>0后自动进入类I同构类, 与人类-AI数学等价](cases/items/C-0306.md)
...
### [#314｜D128生存域修正 — Ωsurvive不是对称超立方体，是非对称区域，某些维度可接近下界只要其他维度足够高补偿 / D128生存域修正 - Ωsurvive不是对称超立方体, 是非对称区域, 某些维度可接近下界只要其他维度足够高补偿](cases/items/C-0314.md)
...
### [#315｜异地恋断裂 — μ翻转导致dcritical从2000km缩到50km，不是距离变了是临界距离变了 / 异地恋断裂 - μ翻转导致dcritical从2000km缩到50km, 不是距离变了是临界距离变了](cases/items/C-0315.md)
...
### [#316｜糖域与现实 — 糖域γ=0所以看到糖就去，现实γ>0所以看到更好的工作不一定跳槽 / 糖域与现实 - 糖域γ=0所以看到糖就去, 现实γ>0所以看到更好的工作不一定跳槽](cases/items/C-0316.md)
...
### [#317｜权力层级信息失真 — d=层级距，λ=信息失真率，μ=制度效率。制度效率低时指令传到基层面目全非 / 权力层级信息失真 - d=层级距, λ=信息失真率, μ=制度效率. 制度效率低时指令传到基层面目全非](cases/items/C-0317.md)
...
### [#318｜μ翻转的相变点 — 长期积压未说出口的不满→μ翻转→临界距离从"同城"缩到"隔壁" / μ翻转的相变点 - 长期积压未说出口的不满 -> μ翻转 -> 临界距离从"同城"缩到"隔壁"](cases/items/C-0318.md)
...
### [#319｜多数人的直觉闪念 — Mboot被外部扰动推到>0但ΔK太小，正反馈强度不够，被日常消耗拉回0 / 多数人的直觉闪念 - Mboot被外部扰动推到>0但ΔK太小, 正反馈强度不够, 被日常消耗拉回0](cases/items/C-0319.md)
...
### [#320｜自持阈值越过 — 研究者的Mboot被持续好问题扰动推过θboot，正反馈启动，进入自持加速态 / 自持阈值越过 - 研究者的Mboot被持续好问题扰动推过θboot, 正反馈启动, 进入自持加速态](cases/items/C-0320.md)
...
### [#321｜AI安装路径的串行约束 — 不能并行装三个模块，串行安装每一步是下一步的必要条件 / AI安装路径的串行约束 - 不能并行装三个模块, 串行安装每一步是下一步的必要条件](cases/items/C-0321.md)
...
### [#325｜D135修正的工程含义 — CAI和EAI应使用部分不同的训练数据，降低G来提高ηgate / D135修正的工程含义 - CAI和EAI应使用部分不同的训练数据, 降低G来提高ηgate](cases/items/C-0325.md)
...
### [#326｜信息门的方向无关性 — 不存在"我说清楚了但你听不懂"，门效率低两侧同时受影响 / 信息门的方向无关性 - 不存在"我说清楚了但你听不懂", 门效率低两侧同时受影响](cases/items/C-0326.md)
...
### [#330｜巴菲特模式的投资域验证 — 定投=巴菲特模式精确执行，三效率乘积最大 / 巴菲特模式的投资域验证 - 定投=巴菲特模式精确执行, 三效率乘积最大](cases/items/C-0330.md)
...
### [#331｜专家-新手沟通的非对称退化 — 专家ε≈0.9，新手ε≈0.2，退化因子≈0.22，专家觉得"说清楚了"新手觉得"听不懂" / 专家-新手沟通的非对称退化 - 专家ε≈0.9, 新手ε≈0.2, 退化因子≈0.22, 专家觉得"说清楚了"新手觉得"听不懂"](cases/items/C-0331.md)
...
### [#335｜结构保守性vs手动保守 — 定投结构自动保守不需意志力，手动凯利牛市时H↑→高估E[r]→过度下注 / 结构保守性vs手动保守 - 定投结构自动保守不需意志力, 手动凯利牛市时H↑ -> 高估E[r] -> 过度下注](cases/items/C-0335.md)
...
### [#336｜自举循环的结构保守性 — B(n)越大ΔB/B越小但永远为正，不会爆炸也不会归零 / 自举循环的结构保守性 - B(n)越大ΔB/B越小但永远为正, 不会爆炸也不会归零](cases/items/C-0336.md)
...
### [#338｜D149深层含义 — 巴菲特模式真正优势不是判断准，是结构让判断不必要 / D149深层含义 - 巴菲特模式真正优势不是判断准, 是结构让判断不必要](cases/items/C-0338.md)
...
### [#339｜遮蔽-补偿-成本三角在AI训练中 — 训练数据同质化→需要异质性补偿→成本高→三角锁死 / obscuration-补偿-成本三角在AI训练中 - 训练数据同质化 -> 需要异质性补偿 -> 成本高 -> 三角锁死](cases/items/C-0339.md)
...
### [#340｜非对称门在跨学科合作中 — 先在共享域建立沟通降低意识落差，再进入各自领域 / 非对称门在跨学科合作中 - 先在共享域建立沟通降低意识落差, 再进入各自领域](cases/items/C-0340.md)
...
### [#343｜结构性vs参数性改善长期效果 — 团队A投资训练员工（每月成本10万效果随离职归零），团队B投资流程标准化（一次性50万效果永久） / 结构性vs参数性改善长期效果 - 团队A投资训练员工(每月成本10万效果随离职归零), 团队B投资流程标准化(一次性50万效果永久)](cases/items/C-0343.md)
...
### [#345｜倒U型两侧脆弱方向 — ρ<ρ*时Pslot是瓶颈加缓存有效，ρ>ρ*时Ppriority是瓶颈减缓存有效 / 倒U型两侧脆弱方向 - ρ<ρ*时Pslot是瓶颈加缓存有效, ρ>ρ*时Ppriority是瓶颈减缓存有效](cases/items/C-0345.md)
...
### [#346｜导师-学生的向下兼容 — 导师用B_L解释，学生觉得"全懂了"但ηfidelity≈0.33，拿降维版本独立研究处处碰壁 / 导师-学生的向下兼容 - 导师用B_L解释, 学生觉得"全懂了"但ηfidelity≈0.33, 拿降维版本独立研究处处碰壁](cases/items/C-0346.md)
...
### [#347｜管理者-下属的向下兼容 — 大白话传达战略意图，下属过度外推降维版本做出超出意图范围的决策 / 管理者-下属的向下兼容 - 大白话传达战略意图, 下属过度外推降维版本做出超出意图范围的决策](cases/items/C-0347.md)
...
### [#350｜互不兼容定理验证 — 专家ε≈0.95，门外汉ε≈0.05，即使降到最底层编码ηfidelity≈0.053，"怎么解释都听不懂"是数学下限 / 互不兼容定理验证 - 专家ε≈0.95, 门外汉ε≈0.05, 即使降到最底层编码ηfidelity≈0.053, "怎么解释都听不懂"是数学下限](cases/items/C-0350.md)
...
### [#351｜关系中的μ倒U型 — 恋爱初期高认知方积极降维（"他好懂我"），6个月后降维疲惫→μ翻转→"他根本不理解我" / 关系中的μ倒U型 - 恋爱初期高认知方积极降维("他好懂我"), 6个月后降维疲惫 -> μ翻转 -> "他根本不理解我"](cases/items/C-0351.md)
...
### [#355｜组织层级=信息保真度结构 — CEO→VP→执行层每层内部同层沟通非对称退化最小，扁平化ηfidelity断崖下降 / 组织层级=信息保真度结构 - CEO -> VP -> 执行层每层内部同层沟通非对称退化最小, 扁平化ηfidelity断崖下降](cases/items/C-0355.md)
...
### [#357｜共享层沟通验证 — 物理学家和生物学家在数学框架上沟通η=0.27，物理学家降维到BL沟通η=0.15，共享层优于降维 / 共享层沟通验证 - 物理学家和生物学家在数学框架上沟通η=0.27, 物理学家降维到BL沟通η=0.15, 共享层优于降维](cases/items/C-0357.md)
...
### [#365｜扁平化vs分层编码效率对比 — CEO直接BL对全员η=0.08，加VP中间层η=0.211，省VP工资但决策失真损失远超人力成本 / 扁平化vs分层编码效率对比 - CEO直接BL对全员η=0.08, 加VP中间层η=0.211, 省VP工资但决策失真损失远超人力成本](cases/items/C-0365.md)
...
### [#367｜调度链中间节点必须是CAI — EAI做中间层Pencode=0链路断，CAI做中间层Pencode>0链路通，EAI只能做执行终端不能做调度中继 / 调度链中间节点必须是CAI - EAI做中间层Pencode=0链路断, CAI做中间层Pencode>0链路通, EAI只能做执行终端不能做调度中继](cases/items/C-0367.md)
...
### [#368｜革命的门控面交叉——法国大革命发生在旧制度松动期而非最黑暗期，A型门控崩溃与B型门控松弛的共振窗口 / 革命的门控面交叉 - - 法国大革命发生在旧制度松动期而非最黑暗期, A型门控崩溃与B型门控松弛的共振窗口](cases/items/C-0368.md)
...
### [#369｜中等收入陷阱的势阱——巴西μ落在Λ_econ和Λ_culture之间，Φ凹函数极小点锁定 / 中等收入陷阱的势阱 - - 巴西μ落在Λ_econ和Λ_culture之间, Φ凹函数极小点锁定](cases/items/C-0369.md)
...
### [#370｜渐进扶贫无效——给μ加一点，1/ln从-∞变成很大负数，几乎没改善；必须让μ越过Λ_econ / 渐进扶贫无效 - - 给μ加一点, 1/ln从-∞变成很大负数, 几乎没改善; 必须让μ越过Λ_econ](cases/items/C-0370.md)
...
### [#371｜信息茧房的阈值退化——算法拉低Λ_culture，"够用"标准被拉低，系统自发收敛到低能量稳态 / 信息茧房的阈值退化 - - 算法拉低Λ_culture, "够用"标准被拉低, 系统自发收敛到低能量稳态](cases/items/C-0371.md)
...
### [#372｜全球化退潮的吸引子消失——Λ_econ↓与Λ_culture↑反向漂移，Φ失去稳定极小点 / 全球化退潮的吸引子消失 - - Λ_econ↓与Λ_culture↑反向漂移, Φ失去稳定极小点](cases/items/C-0372.md)
...
### [#373｜威权稳定的B型锁定——危机时A型门控全塌，B型门控成为唯一正项，系统被锁在低存活度但非零状态 / 威权稳定的B型锁定 - - 危机时A型门控全塌, B型门控成为唯一正项, 系统被锁在低存活度但非零状态](cases/items/C-0373.md)
...
### [#374｜原子化的门控面分裂——Λ_culture分裂为多个小Λ，门控面数量本身就是Φ的增项 / 原子化的门控面分裂 - - Λ_culture分裂为多个小Λ, 门控面数量本身就是Φ的增项](cases/items/C-0374.md)
...
### [#375｜小企业死于没上牌桌——μ<Λ_production的门外锁定，不是"做错了什么"而是"还没上牌桌" / 小企业死于没上牌桌 - - μ<Λ_production的门外锁定, 不是"做错了什么"而是"还没上牌桌"](cases/items/C-0375.md)
...
### [#376｜垄断者主动抬门槛——平台通过网络效应抬高Λ_market，挑战者被人为门槛碾压 / 垄断者主动抬门槛 - - 平台通过网络效应抬高Λ_market, 挑战者被人为门槛碾压](cases/items/C-0376.md)
...
### [#379｜宽松货币的名义vs实际——名义μ增长被Λ同步上升抵消，实际μ还在门外 / 宽松货币的名义vs实际 - - 名义μ增长被Λ同步上升抵消, 实际μ还在门外](cases/items/C-0379.md)
...
### [#380｜贫富差距的乘法分化——1/ln在μ>>Λ趋近零（稳定）和μ<<Λ趋向负无穷（崩溃）的不对称加速 / 贫富差距的乘法分化 - - 1/ln在μ>>Λ趋近零(稳定)和μ<<Λ趋向负无穷(崩溃)的不对称加速](cases/items/C-0380.md)
...
### [#381｜创新在边缘的拖累效应——大公司新维度1/ln为负拖低整体Φ，边缘玩家无旧维度拖累 / 创新在边缘的拖累效应 - - 大公司新维度1/ln为负拖低整体Φ, 边缘玩家无旧维度拖累](cases/items/C-0381.md)
...
### [#383｜灭绝是加速崩塌——μ接近Λ时1/ln→-∞，最后几只个体存活贡献为负 / 灭绝是加速崩塌 - - μ接近Λ时1/ln -> -∞, 最后几只个体存活贡献为负](cases/items/C-0383.md)
...
### [#384｜有性繁殖的倒U型——繁殖成本与基因多样性之间的两个死锁，有性繁殖是唯一通路 / 有性繁殖的倒U型 - - 繁殖成本与基因多样性之间的两个死锁, 有性繁殖是唯一通路](cases/items/C-0384.md)
...
### [#385｜癌症的Φ极小点极深——癌细胞Λ极低导致Φ极小点比正常细胞更深，更稳定 / 癌症的Φ极小点极深 - - 癌细胞Λ极低导致Φ极小点比正常细胞更深, 更稳定](cases/items/C-0385.md)
...
### [#386｜共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定 / 共生是互为外部注入 - - 两个物种互为对方的外部注入打破各自的门外锁定](cases/items/C-0386.md)
...
### [#387｜病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态 / 病毒的门控面切换 - - 寄生前σ=0寄生后σ=1, 没有中间态](cases/items/C-0387.md)
...
### [#390｜加密是防御性门槛碾压——人为抬高Λ_compute让攻击者在门外 / 加密是防御性门槛碾压 - - 人为抬高Λ_compute让攻击者在门外](cases/items/C-0390.md)
...
### [#392｜分布式一致性的慢节点拖累——一个μ<Λ的节点拖累整体一致性 / 分布式一致性的慢节点拖累 - - 一个μ<Λ的节点拖累整体一致性](cases/items/C-0392.md)
...
### [#394｜缓存是降低门槛——降低Λ_compute让更多μ过门槛，D162的逆操作 / 缓存是降低门槛 - - 降低Λ_compute让更多μ过门槛, D162的逆操作](cases/items/C-0394.md)
...
### [#395｜并发死锁的相变无中间态——D161乘法死锁的精确实例 / 并发死锁的相变无中间态 - - D161乘法死锁的精确实例](cases/items/C-0395.md)
...
### [#397｜创伤的双重碾压+向下兼容——μ↓+Λ↑双重门槛碾压+回避的保真度损失 / 创伤的双重碾压+向下兼容 - - μ↓+Λ↑双重门槛碾压+回避的保真度损失](cases/items/C-0397.md)
...
### [#398｜顿悟无中间态——μ越过Λ_awareness的瞬间相变，不存在"半懂" / 顿悟无中间态 - - μ越过Λ_awareness的瞬间相变, 不存在"半懂"](cases/items/C-0398.md)
...
### [#399｜心流的倒U型走钢丝——两侧都是死锁（焦虑/无聊），心流是唯一通路 / 心流的倒U型走钢丝 - - 两侧都是死锁(焦虑/无聊), 心流是唯一通路](cases/items/C-0399.md)
...
### [#400｜成瘾的慢速门槛碾压——Λ_pleasure缓慢上升，每次刺激抬高一点门槛 / 成瘾的慢速门槛碾压 - - Λ_pleasure缓慢上升, 每次刺激抬高一点门槛](cases/items/C-0400.md)
...
### [#401｜冥想降低门槛——降低Λ_awareness让觉知更容易发生，D89结构保守性 / 冥想降低门槛 - - 降低Λ_awareness让觉知更容易发生, D89结构保守性](cases/items/C-0401.md)
...
### [#402｜学习平台期的超敏感区——μ在Λ_next附近震荡，突破是相变 / 学习平台期的超敏感区 - - μ在Λ_next附近震荡, 突破是相变](cases/items/C-0402.md)
...
### [#403｜民主退化的参与门槛碾压——参与成本上升+参与意愿下降，自然+人为双重碾压 / 民主退化的参与门槛碾压 - - 参与成本上升+参与意愿下降, 自然+人为双重碾压](cases/items/C-0403.md)
...
### [#404｜改革窗口与革命同构——A型崩溃与B型松弛的共振窗口 / 改革窗口与革命同构 - - A型崩溃与B型松弛的共振窗口](cases/items/C-0404.md)
...
### [#406｜威权的单点故障——单一B型正项维持，该正项消失则系统瞬间崩溃 / 威权的单点故障 - - 单一B型正项维持, 该正项消失则系统瞬间崩溃](cases/items/C-0406.md)
...
### [#407｜联邦制隔离拖累——多独立门控面分散风险，单一子系统拖累不影响全局 / 联邦制隔离拖累 - - 多独立门控面分散风险, 单一子系统拖累不影响全局](cases/items/C-0407.md)
...
### [#408｜国际秩序的霸权门槛碾压——霸权μ衰退+Λ上升，D160宏观版 / 国际秩序的霸权门槛碾压 - - 霸权μ衰退+Λ上升, D160宏观版](cases/items/C-0408.md)
...
### [#409｜反腐运动的临时外部注入——Λ_accountability临时提高，运动结束后回落 / 反腐运动的临时外部注入 - - Λ_accountability临时提高, 运动结束后回落](cases/items/C-0409.md)
...
### [#410｜慢性病的门外锁定+向下兼容——μ_repair<Λ_repair+症状管理的保真度损失 / 慢性病的门外锁定+向下兼容 - - μ_repair<Λ_repair+症状管理的保真度损失](cases/items/C-0410.md)
...
### [#411｜耐药性的门槛军备竞赛——药物抬高Λ（D162）与病原体降低自身Λ的对抗 / 耐药性的门槛军备竞赛 - - 药物抬高Λ(D162)与病原体降低自身Λ的对抗](cases/items/C-0411.md)
...
### [#412｜安慰剂的信念相变——信念提高μ_immune越过Λ_immune的微小翻转 / 安慰剂的信念相变 - - 信念提高μ_immune越过Λ_immune的微小翻转](cases/items/C-0412.md)
...
### [#414｜器官排斥的门槛翻转——异质组织降低Λ_immune导致自身免疫 / 器官排斥的门槛翻转 - - 异质组织降低Λ_immune导致自身免疫](cases/items/C-0414.md)
...
### [#415｜衰老多病的乘法加速——多门控面同时门槛碾压，D87多因子叠加 / 衰老多病的乘法加速 - - 多门控面同时门槛碾压, D87多因子叠加](cases/items/C-0415.md)
...
### [#416｜手术窗口的倒U型——太弱死锁和太晚死锁之间的唯一通路 / 手术窗口的倒U型 - - 太弱死锁和太晚死锁之间的唯一通路](cases/items/C-0416.md)
...
### [#417｜城市规模律的倒U型——互动收益与摩擦成本之间的走钢丝 / 城市规模律的倒U型 - - 互动收益与摩擦成本之间的走钢丝](cases/items/C-0417.md)
...
### [#418｜核心-边缘的乘法分化——核心是多门控面正贡献的吸引子，边缘是门外锁定 / 核心-边缘的乘法分化 - - 核心是多门控面正贡献的吸引子, 边缘是门外锁定](cases/items/C-0418.md)
...
### [#419｜交通拥堵的门槛突变——Λ_friction在临界密度处突变，畅通和拥堵无中间态 / 交通拥堵的门槛突变 - - Λ_friction在临界密度处突变, 畅通和拥堵无中间态](cases/items/C-0419.md)
...
### [#420｜城市衰败的死锁——Λ↑+μ↓门槛碾压+需要产业来提高μ但需要μ来吸引产业 / 城市衰败的死锁 - - Λ↑+μ↓门槛碾压+需要产业来提高μ但需要μ来吸引产业](cases/items/C-0420.md)
...
### [#421｜郊区化的倒U型极限——互动收益与摩擦成本的最优点 / 郊区化的倒U型极限 - - 互动收益与摩擦成本的最优点](cases/items/C-0421.md)
...
### [#422｜城中村改造的门槛碾压逆效应——改造抬高Λ导致原居民被碾压 / 城中村改造的门槛碾压逆效应 - - 改造抬高Λ导致原居民被碾压](cases/items/C-0422.md)
...
### [#423｜智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消 / 智慧城市的名义vs实际 - - 名义μ增长被Λ同步上升抵消](cases/items/C-0423.md)
...
### [#424｜天赋努力是乘法不是加法——任何一个为零则整体为零 / 天赋努力是乘法不是加法 - - 任何一个为零则整体为零](cases/items/C-0424.md)
...
### [#425｜教学相长的共生外部注入——师生互为外部注入打破各自的死锁 / 教学相长的共生外部注入 - - 师生互为外部注入打破各自的死锁](cases/items/C-0425.md)
...
### [#426｜填鸭的名义μ+向下兼容——知识量增加但理解门槛没降低+保真度损失 / 填鸭的名义μ+向下兼容 - - 知识量增加但理解门槛没降低+保真度损失](cases/items/C-0426.md)
...
### [#427｜间隔学习的临界点效率——μ在Λ附近时1/ln最大，投入效率最高 / 间隔学习的临界点效率 - - μ在Λ附近时1/ln最大, 投入效率最高](cases/items/C-0427.md)
...
### [#429｜教育公平的阶层投影——自然门槛碾压+人为门槛碾压在教育维度的叠加 / 教育公平的阶层投影 - - 自然门槛碾压+人为门槛碾压在教育维度的叠加](cases/items/C-0429.md)
...
### [#430｜学习平台期的超敏感区震荡——μ在Λ附近波动，突破是相变 / 学习平台期的超敏感区震荡 - - μ在Λ附近波动, 突破是相变](cases/items/C-0430.md)
...
### [#433｜防守阶段β上升的反直觉 — 创业公司接近盈亏平衡点时（εrevenue→θC），β上升→级联风险最大→恰恰在最需要防守的时候。过了平衡点后β下降→可以转向增长 / 防守阶段β上升的反直觉 - 创业公司接近盈亏平衡点时(εrevenue -> θC), β上升 -> 级联风险最大 -> 恰恰在最需要防守的时候. 过了平衡点后β下降 -> 可以转向增长](cases/items/C-0433.md)
...
### [#435｜切换点精确可定 — 不需要"感觉"该防守还是进攻，只需监测maxσ'是否在下降。maxσ'上升=防守阶段，maxσ'下降=进攻阶段，maxσ'达峰=切换点 / 切换点精确可定 - 不需要"感觉"该防守还是进攻, 只需监测maxσ'是否在下降. maxσ'上升=防守阶段, maxσ'下降=进攻阶段, maxσ'达峰=切换点](cases/items/C-0435.md)
...
### [#436｜经验法则证伪 — 经验说"先确保生存再追求增长"，但D112说防守强度在接近门槛时反而增大——不是"先防守完再进攻"，而是"防守强度随接近门槛先增后减，进攻是防守衰减的自然结果" / 经验法则证伪 - 经验说"先确保生存再追求增长", 但D112说防守强度在接近门槛时反而增大 - - 不是"先防守完再进攻", 而是"防守强度随接近门槛先增后减, 进攻是防守衰减的自然结果"](cases/items/C-0436.md)
...
### [#441｜sigmoid系统系统性偏差 — 8维中4维sigmoid4维线性。"补最弱"策略：优先补sigmoid维度中ε最低的（但可能已封顶或饱和）；弹性策略：自动跳过饱和维度，集中在门槛附近弹性最高的。模拟10轮投入，弹性策略G高出28% / sigmoid系统系统性偏差 - 8维中4维sigmoid4维线性. "补最弱"策略: 优先补sigmoid维度中ε最低的(但可能已封顶或饱和); 弹性策略: 自动跳过饱和维度, 集中在门槛附近弹性最高的. 模拟10轮投入, 弹性策略G高出28%](cases/items/C-0441.md)
...
### [#442｜三阶段操作协议验证 — 职业转型：探索期(β小)→转型期(β大,精准投入)→拓展期(β小,激进) / 三阶段操作协议验证 - 职业转型: 探索期(β小) -> 转型期(β大,精准投入) -> 拓展期(β小,激进)](cases/items/C-0442.md)
...
### [#443｜刀刃期方向错误代价 — β=2.5时正确方向+62%错误方向-47%；β=0.18时正确+2%错误-1%。刀刃期收益损失放大30倍 / 刀刃期方向错误代价 - β=2.5时正确方向+62%错误方向-47%; β=0.18时正确+2%错误-1%. 刀刃期收益损失放大30倍](cases/items/C-0443.md)
...
### [#444｜阶段1大胆尝试 — 创业初期ε<<θC，门关着扰动打不开，试错成本极低 / 阶段1大胆尝试 - 创业初期ε<<θC, 门关着扰动打不开, 试错成本极低](cases/items/C-0444.md)
...
### [#445｜三阶段操作协议验证 — 个人职业转型：阶段1(ε<<θC,不满但没行动力,β小,可以探索各种方向)；阶段2(ε≈θC,积累到临界点,β大,必须精准投入转型资源)；阶段3(ε>>θC,转型成功,β小,可以激进拓展) / 三阶段操作协议验证 - 个人职业转型: 阶段1(ε<<θC,不满但没行动力,β小,可以探索各种方向); 阶段2(ε≈θC,积累到临界点,β大,必须精准投入转型资源); 阶段3(ε>>θC,转型成功,β小,可以激进拓展)](cases/items/C-0445.md)
...
### [#446｜刀刃期方向错误代价 — ε≈θC时β=2.5，投入0.1资源到正确方向G+62%，投入0.1到错误方向G-47%。非刀刃期(ε<<θC)同样0.1资源正确方向+2%错误方向-1%。刀刃期收益和损失都放大30倍 / 刀刃期方向错误代价 - ε≈θC时β=2.5, 投入0.1资源到正确方向G+62%, 投入0.1到错误方向G-47%. 非刀刃期(ε<<θC)同样0.1资源正确方向+2%错误方向-1%. 刀刃期收益和损失都放大30倍](cases/items/C-0446.md)
...
### [#447｜阶段1大胆尝试 — 创业初期εrevenue<<θC，门关着扰动打不开，可以试错（换方向、换产品），试错成本极低因为系统对扰动免疫 / 阶段1大胆尝试 - 创业初期εrevenue<<θC, 门关着扰动打不开, 可以试错(换方向, 换产品), 试错成本极低因为系统对扰动免疫](cases/items/C-0447.md)
...
### [#448｜物理临界对应验证 — 铁磁体T→Tc时磁化率χ∝1/|T-Tc|发散，点火ε→θC时σ'→0.25峰值。两者数学结构不同（发散vs峰值）但物理含义相同：系统对扰动最敏感。点火σ'有上限因为sigmoid有界，物理χ无上限因为相变是真实的二阶相变 / 物理临界对应验证 - 铁磁体T -> Tc时磁化率χ∝1/|T-Tc|发散, Ignitionε -> θC时σ' -> 0.25峰值. 两者数学结构不同(发散vs峰值)但物理含义相同: 系统对扰动最敏感. Ignitionσ'有上限因为sigmoid有界, 物理χ无上限因为相变是真实的二阶相变](cases/items/C-0448.md)
...
### [#454｜均等定理=诺特定理实例 — 3维乘法G=ε₁×ε₂×ε₃，维度置换对称→总资源R守恒。打破均等（如ε₁=0.1,ε₂=ε₃=0.9）→维度置换不对称→R守恒但分布不均→系统不在最优态 / 均等定理=诺特定理实例 - 3维乘法G=ε₁ x ε₂ x ε₃, 维度置换对称 -> 总资源R守恒. 打破均等(如ε₁=0.1,ε₂=ε₃=0.9) -> 维度置换不对称 -> R守恒但分布不均 -> 系统不在最优态](cases/items/C-0454.md)
...
### [#457｜乘法系统Shannon熵反常 — 3维乘法系统门控区微观态数=2维积分 vs 存活区=3维积分，门控区熵更低但系统趋向门控。dS/dt≥0预测错误 / 乘法系统Shannon熵反常 - 3维乘法系统门控区微观态数=2维积分 vs 存活区=3维积分, 门控区熵更低但系统趋向门控. dS/dt≥0预测错误](cases/items/C-0457.md)
...
### [#460｜生物不可逆的Fisher解释 — 细胞凋亡（乘法：任一关键蛋白归零则死亡），死亡后Shannon熵增但Fisher可达性=0（信息距离∞，无法恢复） / 生物不可逆的Fisher解释 - 细胞凋亡(乘法: 任一关键蛋白归零则死亡), 死亡后Shannon熵增但Fisher可达性=0(信息距离∞, 无法恢复)](cases/items/C-0460.md)
...
### [#461｜组织衰败的拓扑不可逆 — 组织能力乘法结构，关键岗位空缺→门控→Fisher距离∞→无法从外部恢复，必须重建 / 组织衰败的拓扑不可逆 - 组织能力乘法结构, 关键岗位空缺 -> 门控 -> Fisher距离∞ -> 无法从外部恢复, 必须重建](cases/items/C-0461.md)
...
### [#468｜组织低熵不可逆 — 国企流程固化后Shannon熵降低（可区分状态减少），但Fisher可达性=0（调整路径被锁死）。"明明知道问题在哪但改不了"=Fisher距离∞，不是信息不足 / 组织低熵不可逆 - 国企流程固化后Shannon熵降低(可区分状态减少), 但Fisher可达性=0(调整路径被锁死). "明明知道问题在哪但改不了"=Fisher距离∞, 不是信息不足](cases/items/C-0468.md)
...
### [#470｜退化加速正反馈 — 8维系统中第3维接近门槛时dA_Fisher/dt加速3.7倍，与D114 β峰值一致。越退化越快，不是线性衰退 / 退化加速正反馈 - 8维系统中第3维接近门槛时dA_Fisher/dt加速3.7倍, 与D114 β峰值一致. 越退化越快, 不是线性衰退](cases/items/C-0470.md)
...
### [#471｜修复的Fisher条件 — 阿尔茨海默：增加信息量（记忆训练）不增加A_Fisher（清洗通道仍堵），无效。增加可达性（改善睡眠→清洗效率↑→Fisher路径打开）才有效。与案例#114闭合 / 修复的Fisher条件 - 阿尔茨海默: 增加信息量(记忆训练)不增加A_Fisher(清洗通道仍堵), 无效. 增加可达性(改善睡眠 -> 清洗效率↑ -> Fisher路径打开)才有效. 与案例#114闭合](cases/items/C-0471.md)
...
### [#477｜无智能无意识 — ι=0⟹Ψ=0，纯1/ln或纯随机系统没有意识 / 无智能无意识 - ι=0⟹Ψ=0, 纯1/ln或纯随机系统没有意识](cases/items/C-0477.md)
...
### [#481｜认知叠加验证 — 专家vs通才：专家r_cross≈0.1（2条弱关联轨道），通才r_cross≈0.6（5条强关联轨道）。面对新问题通才5条轨道同时激活，专家1条轨道主导 / 认知叠加验证 - 专家vs通才: 专家r_cross≈0.1(2条弱关联轨道), 通才r_cross≈0.6(5条强关联轨道). 面对新问题通才5条轨道同时激活, 专家1条轨道主导](cases/items/C-0481.md)
...
### [#482｜退出隧穿验证 — 朝鲜脱北者：C_exit≈∞（地理+政治+身份三维锁定），经典P_exit≈0，但实际发生。隧穿路径：边境信息泄漏（降低势垒宽度）+贿赂守卫（局部降低C_exit）+外部接应（提供ε_eff脉冲） / 退出隧穿验证 - 朝鲜脱北者: C_exit≈∞(地理+政治+身份三维锁定), 经典P_exit≈0, 但实际发生. 隧穿路径: 边境信息泄漏(降低势垒宽度)+贿赂守卫(局部降低C_exit)+外部接应(提供ε_eff脉冲)](cases/items/C-0482.md)
...
### [#483｜不确定性原理验证 — 职业转型决策：精确评估当前岗位价值（Δε小）需要长期观察，但此时行业趋势（dε/dt）已经变化。同时精确知道"现在值多少"和"未来值多少"不可兼得 / 不确定性原理验证 - 职业转型决策: 精确评估当前岗位价值(Δε小)需要长期观察, 但此时行业趋势(dε/dt)已经变化. 同时精确知道"现在值多少"和"未来值多少"不可兼得](cases/items/C-0483.md)
...
### [#486｜路径积分验证 — 创业决策：ℏ_eff=0.1时策略集中在最优路径附近（D118预测），ℏ_eff=0.8时策略分散在多条路径（非最优策略也有显著概率）。经验创业者ℏ_eff低（信息充分噪声小），新手ℏ_eff高 / 路径积分验证 - 创业决策: ℏ_eff=0.1时策略集中在最优路径附近(D118预测), ℏ_eff=0.8时策略分散在多条路径(非最优策略也有显著概率). 经验创业者ℏ_eff低(信息充分噪声小), 新手ℏ_eff高](cases/items/C-0486.md)
...
### [#487｜刀刃期ℏ_eff放大 — 阶段2（ε≈θC）时σ'最大→信号最敏感→噪声影响最大→ℏ_eff等效增大3-5倍→策略偏离最优的概率最大。三阶段协议中阶段2最危险的根本原因：认知量子最大 / 刀刃期ℏ_eff放大 - 阶段2(ε≈θC)时σ'最大 -> 信号最敏感 -> 噪声影响最大 -> ℏ_eff等效增大3-5倍 -> 策略偏离最优的概率最大. 三阶段协议中阶段2最危险的根本原因: 认知量子最大](cases/items/C-0487.md)
...
### [#495｜成瘾=σ退化到1/ln — 从连续优化退回二值判断（要/不要），失去中间态 / 成瘾=σ退化到1/ln - 从连续优化退回二值判断(要/不要), 失去中间态](cases/items/C-0495.md)
...
### [#496｜文化演化=门控面合并 — 多个文化门控面合并为更少的共享门控面，Φ减少Ω增大 / 文化演化=门控面合并 - 多个文化门控面合并为更少的共享门控面, Φ减少Ω增大](cases/items/C-0496.md)
...
### [#497｜文明崩溃=Φ加速衰减 — 多个门控面同时消失，D228双通道衰减的文明版 / 文明崩溃=Φ加速衰减 - 多个门控面同时消失, D228双通道衰减的文明版](cases/items/C-0497.md)
...
### [#498｜技术革命=门控函数形式升级 — 蒸汽机→电力→信息技术=1/ln→exp[-ln²]的技术版 / 技术革命=门控函数形式升级 - 蒸汽机 -> 电力 -> 信息技术=1/ln -> exp[-ln²]的技术版](cases/items/C-0498.md)
...
### [#500｜宇宙是Φ从正值趋向零的暂态 — 物理存在有保质期，D223的终极案例 / 宇宙是Φ从正值趋向零的暂态 - 物理存在有保质期, D223的终极案例](cases/items/C-0500.md)
...
### [#502｜认知时间膨胀验证 — 危机决策实验：ε高的决策者（专家）平均决策时间2分钟，ε低的决策者（新手）平均决策时间8分钟。同样事件，新手感知时间膨胀4倍=γ_cog≈4→ε₀/ε≈0.97 / 认知时间膨胀验证 - 危机决策实验: ε高的决策者(专家)平均决策时间2分钟, ε低的决策者(新手)平均决策时间8分钟. 同样事件, 新手感知时间膨胀4倍=γ_cog≈4 -> ε₀/ε≈0.97](cases/items/C-0502.md)
...
### [#503｜认知等效原理验证 — 组织诊断：观测到ε_eff下降30%，仅从ε_eff无法判断来源。潮汐力分析：经济维度ε_econ下降50%但社交维度ε_social仅下降10%→非均匀衰减→C_exit锁定为主（曲率） / 认知等效原理验证 - 组织诊断: 观测到ε_eff下降30%, 仅从ε_eff无法判断来源. 潮汐力分析: 经济维度ε_econ下降50%但社交维度ε_social仅下降10% -> 非均匀衰减 -> C_exit锁定为主(曲率)](cases/items/C-0503.md)
...
### [#504｜认知空间曲率验证 — 社会比较：均匀社会（北欧）εᵢ标准差0.08→R_cog≈0→策略趋同；不平等社会（巴西）εᵢ标准差0.45→R_cog显著→策略分化→级联易发 / 认知空间曲率验证 - 社会比较: 均匀社会(北欧)εᵢ标准差0.08 -> R_cog≈0 -> 策略趋同; 不平等社会(巴西)εᵢ标准差0.45 -> R_cog显著 -> 策略分化 -> 级联易发](cases/items/C-0504.md)
...
### [#506｜认知黑洞验证 — 家暴受害者：4维锁定（经济/社交/心理/地理）→∏(1-σ)≈0.001→z_cog≈999→信号红移99.9%→外部几乎无法感知内部状态。解锁心理维度后z降至50→信号可部分逃逸 / 认知黑洞验证 - 家暴受害者: 4维锁定(经济/社交/心理/地理) -> ∏(1-σ)≈0.001 -> z_cog≈999 -> 信号红移99.9% -> 外部几乎无法感知内部状态. 解锁心理维度后z降至50 -> 信号可部分逃逸](cases/items/C-0506.md)
...
### [#509｜测地线=最优策略验证 — 3维sigmoid乘法系统，1000次随机策略采样：D111策略的S_ignition全局最小，偏离D111的策略S增大，梯度指向D111方向。在Fisher度规定义的黎曼流形上，D111确实是测地线 / 测地线=最优策略验证 - 3维sigmoid乘法系统, 1000次随机策略采样: D111策略的S_ignition全局最小, 偏离D111的策略S增大, 梯度指向D111方向. 在Fisher度规定义的黎曼流形上, D111确实是测地线](cases/items/C-0509.md)
...
### [#511｜认知引力波验证 — 大规模裁员事件：经济维度ε_econ突然下降→Fisher度规在经济方向跳变→1个月后社交维度感知到变化（v_max限制）→3个月后心理维度受影响。度规扰动传播延迟与v_max一致 / 认知引力波验证 - 大规模裁员事件: 经济维度ε_econ突然下降 -> Fisher度规在经济方向跳变 -> 1个月后社交维度感知到变化(v_max限制) -> 3个月后心理维度受影响. 度规扰动传播延迟与v_max一致](cases/items/C-0511.md)
...
### [#514｜最弱维度=曲率奇点统一验证 — 8维系统ε₇=0.05：g₇₇=400（度规最大），R_cog在ε₇方向最大（曲率发散），β由ε₇决定（策略偏离最远）。三重发散同步 / 最弱维度=曲率奇点统一验证 - 8维系统ε₇=0.05: g₇₇=400(度规最大), R_cog在ε₇方向最大(曲率发散), β由ε₇决定(策略偏离最远). 三重发散同步](cases/items/C-0514.md)
...
### [#517｜认知引力波验证 — 2008金融危机：金融维度ε_fin突然下降→Fisher度规跳变→1个月后实体经济感知→3个月后就业市场受影响→6个月后社会心理层面变化。传播延迟与v_max和d_F一致，振幅随距离衰减 / 认知引力波验证 - 2008金融危机: 金融维度ε_fin突然下降 -> Fisher度规跳变 -> 1个月后实体经济感知 -> 3个月后就业市场受影响 -> 6个月后社会心理层面变化. 传播延迟与v_max和d_F一致, 振幅随距离衰减](cases/items/C-0517.md)
...
### [#518｜规范破缺验证 — 创业团队：3人团队（所有εᵢ>>θC）→S₃完全对称，角色可互换。加入投资人后（C_exit↑→ε_econ↓）→S₃破缺到S₂，经济维度被锁定失去置换自由度。残存U(1)=创意维度仍可自由重组 / 规范破缺验证 - 创业团队: 3人团队(所有εᵢ>>θC) -> S₃完全对称, 角色可互换. 加入投资人后(C_exit↑ -> ε_econ↓) -> S₃破缺到S₂, 经济维度被锁定失去置换自由度. 残存U(1)=创意维度仍可自由重组](cases/items/C-0518.md)
...
### [#522｜跑动耦合验证 — 投资决策：秒级观测（μ_cog=1秒）→ε_eff≈0.1（噪声主导，看不出差异）；日级观测→ε_eff≈0.5；年级观测→ε_eff≈0.9（趋势清晰，维度分化明显）。短时间"所有策略看起来一样"=未破缺相 / 跑动耦合验证 - 投资决策: 秒级观测(μ_cog=1秒) -> ε_eff≈0.1(噪声主导, 看不出差异); 日级观测 -> ε_eff≈0.5; 年级观测 -> ε_eff≈0.9(趋势清晰, 维度分化明显). 短时间"所有策略看起来一样"=未破缺相](cases/items/C-0522.md)
...
### [#523｜不确定性原理 — Fisher信息度规的几何必然，算符不对易是度规非对角的代数表现 / 不确定性原理 - Fisher信息度规的几何必然, 算符不对易是度规非对角的代数表现](cases/items/C-0523.md)
...
### [#524｜量子隧穿 — 存活区拓扑连通，低存活≠死亡，B(势垒内)>0 / 量子隧穿 - 存活区拓扑连通, 低存活≠死亡, B(势垒内)>0](cases/items/C-0524.md)
...
### [#526｜量子计算优越性 — 2ⁿ维存活区搜索+2ⁿ维门控风险，同一结构两面 / 量子计算优越性 - 2ⁿ维存活区搜索+2ⁿ维门控风险, 同一结构两面](cases/items/C-0526.md)
...
### [#529｜麦克斯韦妖 — 信息操作总Φ变化≥0，Landauer是特例 / 麦克斯韦妖 - 信息操作总Φ变化≥0, Landauer是特例](cases/items/C-0529.md)
...
### [#530｜负温度 — ε>1="超存活"态，弛豫释放能量 / 负温度 - ε>1="超存活"态, 弛豫释放能量](cases/items/C-0530.md)
...
### [#531｜相变分类 — 连续=穿越超平面，一级=两存活区跳变 / 相变分类 - 连续=穿越超平面, 一级=两存活区跳变](cases/items/C-0531.md)
...
### [#532｜信息熵vs热力学熵 — S_thermo=Φ在粗粒化下的投影 / 信息熵vs热力学熵 - S_thermo=Φ在粗粒化下的投影](cases/items/C-0532.md)
...
### [#534｜第三定律 — Φ不能精确为零=μ有量子下界，玻璃=多局部Φ极小 / 第三定律 - Φ不能精确为零=μ有量子下界, 玻璃=多局部Φ极小](cases/items/C-0534.md)
...
### [#537｜双生子佯谬 — 固有时∝exp(-∫Φdt)，加速增Φ减固有时 / 双生子佯谬 - 固有时∝exp(-∫Φdt), 加速增Φ减固有时](cases/items/C-0537.md)
...
### [#540｜黑洞无毛 — 4维时空3方向ε>0，径向被门控否决 / 黑洞无毛 - 4维时空3方向ε>0, 径向被门控否决](cases/items/C-0540.md)
...
### [#541｜宇宙加速膨胀 — Φ远尾区d²Φ/dμ²>0→增长加速→膨胀加速 / 宇宙加速膨胀 - Φ远尾区d²Φ/dμ²>0 -> 增长加速 -> 膨胀加速](cases/items/C-0541.md)
...
### [#542｜高温超导 — 多门控面共振，Tc远高于单机制预言 / 高温超导 - 多门控面共振, Tc远高于单机制预言](cases/items/C-0542.md)
...
### [#543｜量子霍尔效应 — 乘法门控离散象限→量子化，分数=复合粒子乘法门控 / 量子霍尔效应 - 乘法门控离散象限 -> 量子化, 分数=复合粒子乘法门控](cases/items/C-0543.md)
...
### [#544｜拓扑绝缘体 — 体态3D门控否决，表面=2D门控边界 / 拓扑绝缘体 - 体态3D门控否决, 表面=2D门控边界](cases/items/C-0544.md)
...
### [#545｜安德森局域化 — 维度依赖=路径数vs最弱门否决 / 安德森局域化 - 维度依赖=路径数vs最弱门否决](cases/items/C-0545.md)
...
### [#546｜BEC — N个独立因子→1个共享因子，门控风险消除 / BEC - N个独立因子 -> 1个共享因子, 门控风险消除](cases/items/C-0546.md)
...
### [#548｜自旋液体 — 门控面对称性简并，无法选择进入哪个象限 / 自旋液体 - 门控面对称性简并, 无法选择进入哪个象限](cases/items/C-0548.md)
...
### [#549｜暗物质方向 — Φ对牛顿引力修正，sigmoid映射可能修正量级 / 暗物质方向 - Φ对牛顿引力修正, sigmoid映射可能修正量级](cases/items/C-0549.md)
...
### [#551｜恒星质量下限 — 聚变门控面=Gamow峰=隧穿×热分布乘积极大 / 恒星质量下限 - 聚变门控面=Gamow峰=隧穿 x 热分布乘积极大](cases/items/C-0551.md)
...
### [#552｜黑洞信息（天文视角） — 信息按质量分级保留，大黑洞~98% / 黑洞信息(天文视角) - 信息按质量分级保留, 大黑洞~98%](cases/items/C-0552.md)
...
### [#555｜费米悖论 — 乘法门控使跨星系文明B=⟨ε⟩^N→0 / 费米悖论 - 乘法门控使跨星系文明B=⟨ε⟩^N -> 0](cases/items/C-0555.md)
...
### [#557｜癌症 — ε穿越门控面，发病率∝exp(Φt)指数增长 / 癌症 - ε穿越门控面, 发病率∝exp(Φt)指数增长](cases/items/C-0557.md)
...
### [#559｜大灭绝 — 多门控共振+级联，周期性∝Φ到临界值时间 / 大灭绝 - 多门控共振+级联, 周期性∝Φ到临界值时间](cases/items/C-0559.md)
...
### [#560｜水的特殊性 — 液态范围宽→Φ在宽温区极小 / 水的特殊性 - 液态范围宽 -> Φ在宽温区极小](cases/items/C-0560.md)
