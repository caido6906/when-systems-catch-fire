...
### [T39｜Φ跨域统一定理（D224升级） / Φ跨域统一定理(D224升级)](functions/items/T39.md)
...
### [D38｜跨层完整退化，6因子乘法，杠杆排序 / 跨层完整退化, 6因子乘法, 杠杆排序](functions/items/D38.md)
...
### [D47｜点火窗口关闭动力学函数 / Ignition窗口关闭动力学函数](functions/items/D47.md)
...
### [D53｜信号最优流速函数（凯利公式同构） / 信号最优流速函数(凯利公式同构)](functions/items/D53.md)
...
### [D57｜解读偏置函数（核心疑问→错误解读的数学结构） / 解读偏置函数(核心疑问 -> 错误解读的数学结构)](functions/items/D57.md)
...
### [D76｜储能函数，储能双类型 / 储能函数, 储能双类型](functions/items/D76.md)
...
### [D107｜发现瓶颈，变量闭包定律 / 发现瓶颈, 变量闭包定律](functions/items/D107.md)
...
### [D111｜对称-破缺-定向对偶函数（推论级） / 对称-破缺-定向对偶函数(推论级)](functions/items/D111.md)
